...
/**
 * Redis的命令接口,规定了客户端应该实现的命令操作
 *
 * @author Eason
 * @create 2018-04-06 16:24
 **/
public interface Commands {

    void set(final String key, final String value);

    void set(final String key, final String value, final String nxxx, final String expx,
             final long time);
    ...
    void zrangeByScore(final String key, final double min, final double max, final int offset, int count);

    void zrangeByScoreWithScores(final String key, final double min, final double max);

    void zrangeByScoreWithScores(final String key, final double min, final double max, final int offset, final int count);

    void zrangeByScoreWithScores(final String key, final String min, final String max);

    void zrangeByScoreWithScores(final String key, final String min, final String max, final int offset, final int count);
    ...
    void zrevrangeByScoreWithScores(final String key, final double max, final double min, final int offset, final int count);
